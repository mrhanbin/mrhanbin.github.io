...
function(a) {
	function b() {
		var b = (new Date).getTime() - new Date(2016, 9, 16, 9, 0, 0).getTime(),
			c = b % 31104e6,
			d = c % 2592e6,
			e = d % 864e5,
			f = e % 36e5;
	...
	function g() {
		document.addEventListener("keydown", function(a) {
			...
			document.title = document.hidden ? "又去哪鬼混了！" : "天艺娱乐"
		})
	}
	...
	a("#next-page-for-init").bind("click", function() {
		...
		clearTimeout(b), f(), g(), b = setTimeout(function() {
			...
			$(".blogs").attr("src","/").load(function(){
				$(".about").attr("src","/about").load(function(){
					$(".works").attr("src","/works");
				});
			});
		}, 1e3)
	}
